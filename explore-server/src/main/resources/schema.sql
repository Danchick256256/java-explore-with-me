...
CREATE TABLE IF NOT EXISTS comments (
  comment_id BIGINT GENERATED ALWAYS AS IDENTITY CONSTRAINT c_pk PRIMARY KEY,
  event_id BIGINT NOT NULL CONSTRAINT e_id_comment_fk REFERENCES events ON UPDATE CASCADE ON DELETE CASCADE,
  comment_description VARCHAR NOT NULL,
  comment_author BIGINT NOT NULL CONSTRAINT c_owner_fk REFERENCES users ON UPDATE CASCADE ON DELETE CASCADE,
